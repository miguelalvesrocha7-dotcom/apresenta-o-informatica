...
<html lang="pt-BR" class="h-full">
 ...
 <body class="h-full overflow-auto scrollbar-hide" style="font-family: 'Inter', sans-serif;">
  <div id="app" class="w-full min-h-full"><!-- Navigation -->
   ...
   </section><!-- Professional & Office Section -->
   <section id="profissional" class="py-20 bg-slate-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
     <div class="text-center mb-16"><span class="inline-block px-4 py-2 bg-orange-100 text-orange-600 rounded-full text-sm font-medium mb-4"> 📊 Uso Profissional </span>
      <h2 class="text-3xl sm:text-4xl font-bold text-slate-800 mb-4" style="font-family: 'Space Grotesk', sans-serif;">Ferramentas para o Mercado de Trabalho</h2>
      <p class="text-slate-600 max-w-2xl mx-auto">Aprenda a usar as ferramentas profissionais mais demandadas pelas empresas e prepare-se para o futuro.</p>
     </div><!-- Office Suite -->
     <div class="mb-16">
      <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-3xl p-8 md:p-12 border-2 border-blue-200 mb-8">
       <div class="flex items-center gap-6 mb-8">
        <div class="w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center flex-shrink-0">
         <svg class="w-12 h-12 text-white" fill="none" stroke="currentColor" viewbox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
         </svg>
        </div>
        <div>
         <h3 class="text-3xl font-bold text-slate-800 mb-2" style="font-family: 'Space Grotesk', sans-serif;">Microsoft Office 365</h3>
         <p class="text-slate-600">Pacote profissional mais usado no mundo dos negócios</p>
        </div>
       </div>
       <div class="grid grid-cols-1 md:grid-cols-3 gap-6"><!-- Word -->
        <div class="bg-white rounded-2xl p-6 shadow-md hover:shadow-lg transition-all">
         <div class="w-14 h-14 rounded-xl bg-blue-100 flex items-center justify-center mb-4">
          <svg class="w-8 h-8 text-blue-600" fill="currentColor" viewbox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-8-6z" /> <path d="M10 9h4m-4 3h6m-6 3h4" stroke="currentColor" stroke-width="2" fill="none" />
          </svg>
         </div>
         <h4 class="text-lg font-bold text-slate-800 mb-3">Word</h4>
         <ul class="space-y-2 text-sm text-slate-600">
          <li>✓ Criar documentos profissionais</li>
          <li>✓ Formatação avançada de texto</li>
          <li>✓ Inserir tabelas e imagens</li>
          <li>✓ Mala direta e correspondência</li>
          <li>✓ Currículos e cartas de apresentação</li>
         </ul>
        </div><!-- Excel -->
        <div class="bg-white rounded-2xl p-6 shadow-md hover:shadow-lg transition-all">
         <div class="w-14 h-14 rounded-xl bg-green-100 flex items-center justify-center mb-4">
          <svg class="w-8 h-8 text-green-600" fill="currentColor" viewbox="0 0 24 24"><path d="M3 3h18v18H3V3zm2 2v14h14V5H5zm2 2h10v2H7V7zm0 3h10v2H7v-2zm0 3h10v2H7v-2z" />
          </svg>
         </div>
         <h4 class="text-lg font-bold text-slate-800 mb-3">Excel</h4>
         <ul class="space-y-2 text-sm text-slate-600">
          <li>✓ Planilhas e análise de dados</li>
          <li>✓ Fórmulas e funções avançadas</li>
          <li>✓ Gráficos e dashboards</li>
          <li>✓ Relatórios financeiros</li>
          <li>✓ Previsões e análise de cenários</li>
         </ul>
        </div><!-- PowerPoint -->
        <div class="bg-white rounded-2xl p-6 shadow-md hover:shadow-lg transition-all">
         <div class="w-14 h-14 rounded-xl bg-orange-100 flex items-center justify-center mb-4">
          <svg class="w-8 h-8 text-orange-600" fill="currentColor" viewbox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" />
          </svg>
         </div>
         <h4 class="text-lg font-bold text-slate-800 mb-3">PowerPoint</h4>
         <ul class="space-y-2 text-sm text-slate-600">
          <li>✓ Apresentações impactantes</li>
          <li>✓ Design profissional e templates</li>
          <li>✓ Animações e transições</li>
          <li>✓ Apresentações para reuniões</li>
          <li>✓ Pitch de projetos e ideias</li>
         </ul>
        </div>
       </div>
      </div><!-- Professional Skills -->
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8"><!-- Why Office Matters -->
       <div class="bg-white rounded-3xl p-8 shadow-lg border border-slate-100">
        <h3 class="text-2xl font-bold text-slate-800 mb-6" style="font-family: 'Space Grotesk', sans-serif;">Por que dominar Office é essencial?</h3>
        <div class="space-y-4">
         <div class="flex gap-4">
          <div class="w-8 h-8 rounded-lg bg-blue-100 flex items-center justify-center flex-shrink-0 mt-1"><span class="text-blue-600 font-bold">1</span>
          </div>
          <div>
           <h4 class="font-semibold text-slate-800 mb-1">95% das empresas usam Office</h4>
           <p class="text-slate-600 text-sm">Praticamente todo trabalho administrativo e de gestão usa estas ferramentas</p>
          </div>
         </div>
         <div class="flex gap-4">
          <div class="w-8 h-8 rounded-lg bg-green-100 flex items-center justify-center flex-shrink-0 mt-1"><span class="text-green-600 font-bold">2</span>
          </div>
          <div>
           <h4 class="font-semibold text-slate-800 mb-1">Diferencial no currículo</h4>
           <p class="text-slate-600 text-sm">Domínio avançado dessas ferramentas é muito valorizado em processos seletivos</p>
          </div>
         </div>
         <div class="flex gap-4">
          <div class="w-8 h-8 rounded-lg bg-purple-100 flex items-center justify-center flex-shrink-0 mt-1"><span class="text-purple-600 font-bold">3</span>
          </div>
          <div>
           <h4 class="font-semibold text-slate-800 mb-1">Produtividade profissional</h4>
           <p class="text-slate-600 text-sm">Economize tempo e trabalhe de forma mais eficiente em qualquer ambiente corporativo</p>
          </div>
         </div>
         <div class="flex gap-4">
          <div class="w-8 h-8 rounded-lg bg-orange-100 flex items-center justify-center flex-shrink-0 mt-1"><span class="text-orange-600 font-bold">4</span>
          </div>
          <div>
           <h4 class="font-semibold text-slate-800 mb-1">Compatibilidade universal</h4>
           <p class="text-slate-600 text-sm">Qualquer empresa ou cliente reconhecerá e usará seus arquivos sem problemas</p>
          </div>
         </div>
        </div>
       </div><!-- Professional Applications -->
       <div class="bg-white rounded-3xl p-8 shadow-lg border border-slate-100">
        <h3 class="text-2xl font-bold text-slate-800 mb-6" style="font-family: 'Space Grotesk', sans-serif;">Aplicações profissionais reais</h3>
        <div class="space-y-4">
         <div class="p-4 rounded-xl bg-gradient-to-r from-blue-50 to-transparent border-l-4 border-blue-500">
          <h4 class="font-semibold text-slate-800 mb-1">📈 Analista Financeiro</h4>
          <p class="text-slate-600 text-sm">Usar Excel para criar planilhas de análise, gráficos de tendências e relatórios executivos</p>
         </div>
         <div class="p-4 rounded-xl bg-gradient-to-r from-green-50 to-transparent border-l-4 border-green-500">
          <h4 class="font-semibold text-slate-800 mb-1">📄 Coordenador de Projetos</h4>
          <p class="text-slate-600 text-sm">Documentar cronogramas em Word, controlar orçamentos em Excel e apresentar ao cliente em PowerPoint</p>
         </div>
         <div class="p-4 rounded-xl bg-gradient-to-r from-orange-50 to-transparent border-l-4 border-orange-500">
          <h4 class="font-semibold text-slate-800 mb-1">🎯 Gerente Comercial</h4>
          <p class="text-slate-600 text-sm">Controlar vendas em Excel, documentar contratos em Word e apresentar metas em PowerPoint</p>
         </div>
         <div class="p-4 rounded-xl bg-gradient-to-r from-purple-50 to-transparent border-l-4 border-purple-500">
          <h4 class="font-semibold text-slate-800 mb-1">📊 RH Especialista</h4>
          <p class="text-slate-600 text-sm">Gerenciar dados de funcionários em Excel, criar comunicados em Word e apresentações em PowerPoint</p>
         </div>
        </div>
       </div>
      </div>
     </div><!-- Advanced Tips -->
     <div class="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-3xl p-8 md:p-12 border-2 border-indigo-200">
      <h3 class="text-2xl font-bold text-slate-800 mb-8 text-center" style="font-family: 'Space Grotesk', sans-serif;">💡 Dicas Profissionais Avançadas</h3>
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
       <div class="bg-white rounded-xl p-6">
        <div class="text-2xl mb-3">
         📋
        </div>
        <h4 class="font-bold text-slate-800 mb-2">Modelos Profissionais</h4>
        <p class="text-sm text-slate-600">Use templates prontos para ganhar tempo e manter consistência visual</p>
       </div>
       <div class="bg-white rounded-xl p-6">
        <div class="text-2xl mb-3">
         🔗
        </div>
        <h4 class="font-bold text-slate-800 mb-2">Integração entre apps</h4>
        <p class="text-sm text-slate-600">Copie dados do Excel para Word e PowerPoint mantendo a formatação</p>
       </div>
       <div class="bg-white rounded-xl p-6">
        <div class="text-2xl mb-3">
         ☁️
        </div>
        <h4 class="font-bold text-slate-800 mb-2">OneDrive e Nuvem</h4>
        <p class="text-sm text-slate-600">Acesse seus arquivos de qualquer lugar e colabore em tempo real</p>
       </div>
       <div class="bg-white rounded-xl p-6">
        <div class="text-2xl mb-3">
         🔐
        </div>
        <h4 class="font-bold text-slate-800 mb-2">Segurança Profissional</h4>
        <p class="text-sm text-slate-600">Proteja documentos com senhas e controle permissões de acesso</p>
       </div>
      </div>
     </div><!-- Industry Focus -->
     <div class="mt-16 bg-white rounded-3xl p-8 md:p-12 shadow-lg border border-slate-100">
      <h3 class="text-2xl font-bold text-slate-800 mb-8 text-center" style="font-family: 'Space Grotesk', sans-serif;">🏢 Setores que Mais Usam Office</h3>
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
       <div class="p-6 rounded-xl border-2 border-slate-200 hover:border-blue-500 transition-all"><span class="inline-block bg-blue-100 text-blue-600 px-3 py-1 rounded-full text-sm font-semibold mb-3">Finanças</span>
        <p class="text-slate-600 text-sm"><strong>Excel:</strong> Análise financeira, previsões orçamentárias e auditoria</p>
       </div>
       <div class="p-6 rounded-xl border-2 border-slate-200 hover:border-green-500 transition-all"><span class="inline-block bg-green-100 text-green-600 px-3 py-1 rounded-full text-sm font-semibold mb-3">Administração</span>
        <p class="text-slate-600 text-sm"><strong>Word:</strong> Ofícios, memorandos e documentação administrativa</p>
       </div>
       <div class="p-6 rounded-xl border-2 border-slate-200 hover:border-purple-500 transition-all"><span class="inline-block bg-purple-100 text-purple-600 px-3 py-1 rounded-full text-sm font-semibold mb-3">Vendas</span>
        <p class="text-slate-600 text-sm"><strong>PowerPoint:</strong> Apresentações de produtos e fechamento de negócios</p>
       </div>
       <div class="p-6 rounded-xl border-2 border-slate-200 hover:border-orange-500 transition-all"><span class="inline-block bg-orange-100 text-orange-600 px-3 py-1 rounded-full text-sm font-semibold mb-3">RH</span>
        <p class="text-slate-600 text-sm"><strong>Excel + Word:</strong> Gestão de pessoal e documentação de contratos</p>
       </div>
       <div class="p-6 rounded-xl border-2 border-slate-200 hover:border-red-500 transition-all"><span class="inline-block bg-red-100 text-red-600 px-3 py-1 rounded-full text-sm font-semibold mb-3">Educação</span>
        <p class="text-slate-600 text-sm"><strong>Word:</strong> Planos de aula, avaliações e relatórios de alunos</p>
       </div>
       <div class="p-6 rounded-xl border-2 border-slate-200 hover:border-indigo-500 transition-all"><span class="inline-block bg-indigo-100 text-indigo-600 px-3 py-1 rounded-full text-sm font-semibold mb-3">Consultoria</span>
        <p class="text-slate-600 text-sm"><strong>Todos:</strong> Relatórios, dados e apresentações para clientes</p>
       </div>
      </div>
     </div>
    </div>
     ...
     <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8"><!-- Logo & Description -->
      ...
      <div>
       ...
       <ul class="space-y-2">
        ...
        <li><a href="#profissional" class="text-slate-400 hover:text-white transition-colors text-sm">Profissional</a></li>
  ...
  <script>
      ...
      return `
        <div class="p-8">
          <div class="text-center mb-6">
            ...
            <p class="text-slate-500 text-sm">Arraste os blocos na ordem correta!</p>
          </div>
          
          <div class="mb-6">
            <p class="text-slate-600 font-semibold mb-4 text-center">Objetivo: Faça o robô chegar na estrela</p>
            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 text-center">
              ...
              <div class="flex items-center justify-center gap-2 mt-4">
                <span class="text-2xl">Passos:</span>
                <span id="blocoSteps" class="text-3xl font-bold text-blue-600">0/3</span>
              </div>
            </div>
          </div>

          <div class="bg-slate-50 rounded-xl p-4 mb-6">
            <p class="text-sm text-slate-600 font-semibold mb-3">Blocos Disponíveis:</p>
            <div class="flex flex-wrap gap-2" id="blocoAvailable">
              <button class="bloco-btn bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg font-semibold transition-all" data-step="1">▶️ Andar</button>
              <button class="bloco-btn bg-purple-500 hover:bg-purple-600 text-white px-4 py-2 rounded-lg font-semibold transition-all" data-step="2">🔄 Virar</button>
              <button class="bloco-btn bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-lg font-semibold transition-all" data-step="3">⏸️ Esperar</button>
            </div>
          </div>

          <div class="bg-blue-50 border-2 border-blue-300 rounded-xl p-4 mb-6 min-h-[100px]">
            <p class="text-sm text-slate-600 font-semibold mb-2">Sequência (clique nos blocos acima):</p>
            <div id="blocoSequence" class="flex flex-wrap gap-2">
              <span class="text-slate-400 text-sm italic">Selecione os blocos...</span>
            </div>
          </div>

          <div class="flex gap-4">
            <button onclick="resetBlocoGame()" class="flex-1 py-3 rounded-xl border-2 border-slate-200 text-slate-600 font-semibold hover:bg-slate-50 transition-all">
              Limpar
            </button>
    ...
    let blocoSequence = [];
    function setupBlocoGame() {
      document.querySelectorAll('.bloco-btn').forEach(btn => {
        btn.addEventListener('click', () => {
          blocoSequence.push(btn.dataset.step);
          updateBlocoDisplay();
        });
      });
    }
    function updateBlocoDisplay() {
      ...
      if (blocoSequence.length === 0) {
        display.innerHTML = '<span class="text-slate-400 text-sm italic">Selecione os blocos...</span>';
      } else {
        display.innerHTML = blocoSequence.map((step, idx) => {
          const icons = ['▶️ Andar', '🔄 Virar', '⏸️ Esperar'];
          return `<span class="bg-blue-500 text-white px-3 py-1 rounded-lg text-sm font-semibold">${icons[step-1]}</span>`;
        }).join('');
      }
      document.getElementById('blocoSteps').textContent = `${blocoSequence.length}/3`;
    }
    ...
    function checkBlocoGame() {
      if (blocoSequence.length === 3 && blocoSequence[0] === '1' && blocoSequence[1] === '2' && blocoSequence[2] === '1') {
        addPoints(100);
        closeModal();
        showToast('🎉 Perfeito! +100 pontos!');
      } else {
    ...
    function renderHTMLGame() {
      return `
        <div class="p-8">
          ...
          <div class="mb-6">
            <p class="text-slate-600 font-semibold mb-3">Tarefa: Escolha as tags corretas</p>
            <div class="bg-slate-100 rounded-xl p-4 mb-4">
              <p class="text-sm text-slate-700 font-mono bg-white p-3 rounded border-l-4 border-blue-500">
                &lt;${document.createElement('span').innerHTML = '?'}&gt;
                <span id="htmlContent">Olá, Mundo!</span>
                &lt;/${document.createElement('span').innerHTML = '?'}&gt;
              </p>
            </div>
            <p class="text-sm text-slate-500 mb-4">Qual tag deveria envolver este texto?</p>
          </div>

          <div class="grid grid-cols-2 gap-3 mb-6">
            <button onclick="checkHTML('p')" class="html-option p-4 rounded-lg border-2 border-slate-300 hover:border-blue-500 hover:bg-blue-50 transition-all text-center">
              <div class="font-mono font-bold text-blue-600">&lt;p&gt;</div>
              <div class="text-xs text-slate-500 mt-1">Parágrafo</div>
            </button>
            <button onclick="checkHTML('div')" class="html-option p-4 rounded-lg border-2 border-slate-300 hover:border-blue-500 hover:bg-blue-50 transition-all text-center">
              <div class="font-mono font-bold text-green-600">&lt;div&gt;</div>
              <div class="text-xs text-slate-500 mt-1">Divisão</div>
            </button>
            <button onclick="checkHTML('h1')" class="html-option p-4 rounded-lg border-2 border-slate-300 hover:border-blue-500 hover:bg-blue-50 transition-all text-center">
              <div class="font-mono font-bold text-purple-600">&lt;h1&gt;</div>
              <div class="text-xs text-slate-500 mt-1">Título</div>
            </button>
            <button onclick="checkHTML('span')" class="html-option p-4 rounded-lg border-2 border-slate-300 hover:border-blue-500 hover:bg-blue-50 transition-all text-center">
              <div class="font-mono font-bold text-orange-600">&lt;span&gt;</div>
              <div class="text-xs text-slate-500 mt-1">Texto</div>
            </button>
          </div>
    ...
    function checkHTML(tag) {
      if (tag === 'p') {
        addPoints(150);
        closeModal();
        showToast('✅ Correto! &lt;p&gt; é perfeito! +150 pontos!');
      } else {
      ...
      return `
        <div class="p-8">
          <div class="text-center mb-6">
            ...
            <p class="text-slate-500 text-sm">Complete o código</p>
          </div>

          <div class="mb-6 bg-slate-900 text-white p-4 rounded-lg font-mono text-sm overflow-x-auto">
            <div>nome = <span class="text-green-400">"Alice"</span></div>
            <div>idade = <span class="text-yellow-400">15</span></div>
            <div>print(<span class="text-blue-400">"Olá, "</span> + ___________)</div>
          </div>

          <p class="text-slate-600 font-semibold mb-4 text-center">O que falta no código?</p>

          <div class="grid grid-cols-2 gap-3 mb-6">
            <button onclick="checkPython('nome')" class="python-option p-4 rounded-lg border-2 border-slate-300 hover:border-green-500 hover:bg-green-50 transition-all text-center">
              <div class="font-mono font-bold text-green-600">nome</div>
              <div class="text-xs text-slate-500 mt-1">Variável</div>
            </button>
            <button onclick="checkPython('idade')" class="python-option p-4 rounded-lg border-2 border-slate-300 hover:border-blue-500 hover:bg-blue-50 transition-all text-center">
              <div class="font-mono font-bold text-blue-600">idade</div>
              <div class="text-xs text-slate-500 mt-1">Número</div>
            </button>
            <button onclick="checkPython('print')" class="python-option p-4 rounded-lg border-2 border-slate-300 hover:border-purple-500 hover:bg-purple-50 transition-all text-center">
              <div class="font-mono font-bold text-purple-600">print()</div>
              <div class="text-xs text-slate-500 mt-1">Função</div>
            </button>
            <button onclick="checkPython('input')" class="python-option p-4 rounded-lg border-2 border-slate-300 hover:border-orange-500 hover:bg-orange-50 transition-all text-center">
              <div class="font-mono font-bold text-orange-600">input()</div>
              <div class="text-xs text-slate-500 mt-1">Entrada</div>
            </button>
          </div>
    ...
    function checkPython(answer) {
      if (answer === 'nome') {
        addPoints(150);
        closeModal();
        showToast('✅ Excelente! É preciso da variável nome! +150 pontos!');
      } else {
        showToast('❌ Tente novamente! Dica: precisa de uma variável.');
      }
    }
      ...
      return `
        <div class="p-8">
          <div class="text-center mb-6">
            ...
            <p class="text-slate-500 text-sm">Relacione cada componente com sua função</p>
          </div>

          <div class="space-y-3 mb-6">
            <div class="info-match p-4 rounded-lg border-2 border-slate-300 hover:border-blue-500 bg-gradient-to-r from-blue-50 to-transparent transition-all cursor-pointer" onclick="checkInfo('cpu')">
              <div class="font-bold text-slate-800">CPU</div>
              <div class="text-sm text-slate-500">Processador do computador</div>
            </div>
            <div class="info-match p-4 rounded-lg border-2 border-slate-300 hover:border-green-500 bg-gradient-to-r from-green-50 to-transparent transition-all cursor-pointer" onclick="checkInfo('ram')">
              <div class="font-bold text-slate-800">RAM</div>
              <div class="text-sm text-slate-500">Memória rápida e temporária</div>
            </div>
            <div class="info-match p-4 rounded-lg border-2 border-slate-300 hover:border-purple-500 bg-gradient-to-r from-purple-50 to-transparent transition-all cursor-pointer" onclick="checkInfo('hd')">
              <div class="font-bold text-slate-800">HD</div>
              <div class="text-sm text-slate-500">Armazena seus arquivos</div>
            </div>
          </div>

          <p class="text-sm text-slate-500 text-center mb-6">Clique na resposta correta para: qual é o "cérebro" do computador?</p>
    ...
    function checkInfo(answer) {
      if (answer === 'cpu') {
        addPoints(100);
        closeModal();
        showToast('🎯 Correto! CPU é o cérebro! +100 pontos!');
      } else {
        showToast('❌ Tente novamente! A CPU é o processador.');
      }
    }

    // JOGO 5: Segurança Digital
    function renderSegurancaGame() {
      return `
        <div class="p-8">
          ...
          <div class="space-y-3 mb-6">
            <button onclick="checkSeguranca('fraca')" class="seg-option w-full p-4 rounded-lg border-2 border-slate-300 hover:border-red-500 hover:bg-red-50 transition-all text-left">
              <div class="font-bold text-slate-800">❌ 123456</div>
              <div class="text-sm text-slate-500">Muito comum e fraca</div>
            </button>
            <button onclick="checkSeguranca('media')" class="seg-option w-full p-4 rounded-lg border-2 border-slate-300 hover:border-yellow-500 hover:bg-yellow-50 transition-all text-left">
              <div class="font-bold text-slate-800">⚠️ Alice2024</div>
              <div class="text-sm text-slate-500">Usa nome + número</div>
            </button>
            <button onclick="checkSeguranca('forte')" class="seg-option w-full p-4 rounded-lg border-2 border-slate-300 hover:border-green-500 hover:bg-green-50 transition-all text-left">
              <div class="font-bold text-green-600">✅ G7@mK9#xL2pQ</div>
              <div class="text-sm text-slate-500">Mistura maiúsculas, números e símbolos</div>
            </button>
          </div>

          <div class="bg-blue-50 rounded-lg p-4 mb-6 border-l-4 border-blue-500">
            <p class="text-sm text-slate-700"><strong>💡 Dica:</strong> Uma boa senha tem maiúsculas, minúsculas, números e símbolos!</p>
          </div>
    ...
    function checkSeguranca(answer) {
      if (answer === 'forte') {
        addPoints(200);
        closeModal();
        showToast('🔐 Segurança em primeiro lugar! +200 pontos!');
      } else {
        showToast('❌ Tente novamente! Procure uma senha com mais caracteres especiais.');
      }
    }
 ...
 <script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'9d31b76ac3be4585',t:'MTc3MTk2NDk4MS4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
